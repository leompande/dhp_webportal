    ...
    function utilityService($http) {
      var profile = this;
        ...
        profile.loadOrganisationUnits = function(){
            ...
            return $http.get(profile.basePortal+'api/organisationUnits.json?parent=m0frOspS7JY&level=1&fields=id,name,children[id,name,children[id,name]]&paging=false').then(handleSuccess, handleError('Error creating user'));
        }
